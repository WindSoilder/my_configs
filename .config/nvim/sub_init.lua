...
require('nvim-treesitter.configs').setup {
  ...
  -- needs to ensure markdown, markdown_inline, bash
  -- or else we'll likely to get a problem when opening these files
  -- because these parsers whichi shipped with neovim itself are not up to date
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'vimdoc', 'vim', 'markdown', 'markdown_inline', 'bash' },
